create procedure [reconcile_accounts].[test when transaction is for different account then it is ignored]
as
	...
	union
	select 2, 100, '20160401 12:34'					--a single transaction between the two dates of 100 but in a different account
